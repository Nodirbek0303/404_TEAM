...
export const internsData: Intern[] = [
  {
    ...
    completedProjects: [
      {
        title: 'CYBERAQUA — sug\'orish tizimini avtomatlashtirish',
        period: 'Yakunlangan',
        note: 'Loyihada mukammal tarzda ishtirok etdi.',
      },
      {
    ...
    curatorGrades: [
      { category: 'CYBERAQUA — sug\'orish tizimi', score: 20, max: 20 },
      { category: 'REPETITOR — onlayn ta\'lim', score: 20, max: 20 },
      { category: 'KICHKITOY — sun\'iy intellekt', score: 50, max: 50, pending: true },
    ],
    curatorComment: 'Ikkala yakunlangan loyihada ham mukammal darajada ishtirok etdi va har biriga to\'liq 20 balldan qo\'yildi. Hozirda KICHKITOY sun\'iy intellekti ustida sifatli ishlamoqda — loyiha yakunlangach 50 ball kutilmoqda.',
    overallGrade: 40,
    expectedGrade: 50,
  },
  {
