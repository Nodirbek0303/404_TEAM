  ...
  return (
    <section id="home" className="relative min-h-[92vh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={HERO_BG} alt="" className="w-full h-full object-cover object-center scale-105 opacity-55" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#050510]/85 via-[#050510]/75 to-[#050510]/70" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#050510]/90 via-transparent to-[#050510]/30" />
      </div>
